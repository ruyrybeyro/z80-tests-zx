...
; 2. READ AND SAVE AY REGISTER 1
; 3. MODIFY AY REGISTER 1 USING OUT (C),<0|0FFH>
;    (DB 0EDH, 071H) UNDOCUMENTED INSTRUCTION:
;      ON AN NMOS CPU: OUT (C),0
;      ON A CMOS CPU: OUT (C),0FFH
; 4. READ AND SAVE AY REGISTER 1
; 7. ENABLE INTERRUPTS
...
MSGSIGNIN	DB	'Z80 Processor Type Detection (C) 2024 Sergey Kiselev'
		DB	0DH
MSGRUI		DB	' 2025 Ported ZX Spectrum 128k/48K+AY  Rui Ribeiro', 0DH
MSGCRLF		DB	0DH,'$'
