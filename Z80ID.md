...
|-----|-----------|-----------|---------------|--------------|--------|
| Zilog Z8400APS | 0x00 | Pass | 0xFF | CMOS:00 U880:00 XF/YF:FF | Original NMOS design |
| Zilog Z80 | 0x00 | Pass | 0xFF | CMOS:00 U880:00 XF/YF:FF | Standard NMOS |
| Zilog Z08400 | 0x00 | Pass | 0xFF | CMOS:00 U880:00 XF/YF:FF | Similar NMOS CPU |
| Zilog Z84C0010PEG | 0xFF | Pass | 0xFF | CMOS:2C U880:00 XF/YF:FF | Standard CMOS |
| Zilog Z84C00 | 0xFF | Pass | 0xFF | CMOS:2C U880:00 XF/YF:FF | CMOS with enhanced timing |
...
| CPU | CMOS Test | U880 Test | XF/YF Pattern | Test Results | Notes |
|-----|-----------|-----------|---------------|--------------|--------|
| NEC D780C | 0x00 | Pass | 0xFD | CMOS:00 U880:00 XF/YF:FD | Lacks Q register implementation |
| NEC D70008AC | 0xFF | Pass | 0x1F/0x0D | CMOS:2C U880:00 XF/YF:1F | Clean-room design, 99.9% compatible |
| NEC D70008AC | 0xFF | Pass | 0x0D | CMOS:2C U880:00 XF/YF:0D | Specimen variation |
...
```
For CMOS results with XF/YF ≤ 0x1F:
│
├─ Check: (XF/YF & 0x0F) ≥ 0x03?
│  ├─ YES → NEC D70008AC confirmed
│  └─ NO → Unknown CMOS clone
│
└─ Additional validation recommended for specimens
   with inconsistent XF/YF patterns
```
